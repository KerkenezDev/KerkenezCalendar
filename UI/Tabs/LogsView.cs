...
namespace KerkenezCalendar.UI.Tabs
{
    public class LogsView : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Text = "📋  Live System & Activity Logs",
                Dock = DockStyle.Left,
                AutoSize = true,
        ...
        public void AppendLog(string message)
        {
            ...
            else if (message.Contains("Daemon:")) color = Color.FromArgb(240, 210, 100);
            else if (message.Contains("Event:")) color = Color.FromArgb(200, 180, 255);
        ...
        private void OnCopyClick(object? sender, EventArgs e)
        {
            if (_rtbLog.TextLength > 0)
            {
                ...
                MessageBox.Show(this, "Console log copied to clipboard!", "Copied", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
    }
}
